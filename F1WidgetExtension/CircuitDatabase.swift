...
struct CircuitDatabase {
    static let circuits: [CircuitInfo] = [
        ...
        CircuitInfo(circuitId: "IMO", length: "4.909 km", turns: 19, lapRecord: "1:15.484", lapRecordHolder: "Lewis Hamilton",       lapRecordYear: 2020, latitude:  44.3439, longitude:  11.7167),
